...
import Image1 from '../public/homepage_1_s.jpeg';
import Image2 from '../public/homepage_2_s.jpeg';
        ...
        <div style={{ display: "flex", flexDirection: "column", height: "fit-content", overflow: "auto", width: "100vw", padding: 0, margin: 0 }}>
          ...
          <div className="home-main-content-container">
            <div className="home-center-wrapper">
              <div>
                <h4>Varmt välkommen till vårt bröllop!</h4>
                <div className="divider-wrapper">
                  <div />
                </div>

                <p>Vi ser så mycket fram emot att fira vår stora dag och skapa minnen för livet tillsammans med er!</p>
                <p style={{ marginTop: 20 }}>Här på vår hemsida hittar ni all information ni behöver om bröllopet, och glöm inte att <span style={{textDecoration: "underline"}}>OSA senast den 31 mars.</span></p>
                <p style={{ marginTop: 20 }}>Varmt välkommen!</p>
                <p style={{ marginTop: 10 }}>Tove & Christian</p>

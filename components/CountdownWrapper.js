...
const CountdownWrapper = (props) => {
    ...
    return (
        <div style={{ flex: 1, gap: 10, display: "flex", flexDirection: "column", height: "fit-content", padding: "40px 0", width: "100vw", backgroundColor: "#A89C8F", alignItems: "center", justifyContent: "center" }}>
